...
class UserText:
    def __init__(self):
        self._stock = {
            ...
            "reminder": ("Привіт!\n"
                        "Пройшов вже деякий час, як ви стали частинкою нашого ком'юніті і можливо вже "
                        "змогли оцінити функціонал нашого бота.\n\n"
                         "Хочемо ще раз нагадати можливості цього бота:\n\n"
                         "- отримати рецепти після події \n\n"
                         "- відправити запит на бронювання події \n\n"
                         "- отримувати нові рецепти та знання з кулінарії від Команди Шеф-Кухарів Гастролофт \n\n"
                         "- бути в курсі останніх подій у Кулінарній студії \n\n"
                         "- переглянути цікаві статті від авторів і Шеф-кухарів  \n\n"
                         "- у разі питань - швидко зв’язатись з нашим адміністратором студії \n\n"
                         "- відправити ваш щирий та чесний відгук\n\n"
                         "Ще раз вітаємо у чарівному і ціквому світі смакових вражень у кулінарній студії GastroLoft!"),
